...
/** Added by later migrations (0003, 0004 and 0005 have their own roll-forward tests). */
const LATER_TABLES: MySqlTable[] = [externalIdentities, authEvents, generatedUploads, brandGuidelineAuthors];
